...
2. Add `https://github.com/eXaminator/ha-zaco-vacuum` with category **Integration**.
3. Search for **ZACO Robot Vacuum** in HACS and install it.
4. Restart Home Assistant.
5. Go to **Settings > Devices & Services > Add Integration** and search for **ZACO**.
